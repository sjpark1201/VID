...
# CODE EXPLANATION: the code below codes the user interface known as pyschopy

# Design Portion (Color and Font) coded and debugged by Minchae Kim
# Time: 5 hours
...
body_temperature = int(float(answer))
